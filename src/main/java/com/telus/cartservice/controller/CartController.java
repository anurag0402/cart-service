package com.telus.cartservice.controller;

import com.telus.cartservice.dto.CartItemDTO;
import com.telus.cartservice.service.CartService;
...
public class CartController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<List<CartItemDTO>> getUserCart(@PathVariable String userId) {
